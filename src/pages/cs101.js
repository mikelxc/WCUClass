...
const SecondPage = () => (
  ...
  <ul>
    ...
    <ul>
      ...
      <li><a href="https://class.wildchickenuniversity.com/python/hw1.zip">Homework</a> and <a href="https://class.wildchickenuniversity.com/python/hw1Specification.pdf">Specification</a></li><a href="https://class.wildchickenuniversity.com/python/hw1Specification.pdf">
      </a></ul><a href="https://class.wildchickenuniversity.com/python/hw1Specification.pdf">
      <video controls muted src="https://class.wildchickenuniversity.com/python/Lecture1.mp4" width={300} height={200}>
        Sorry, your browser doesn't support embedded videos.
      </video>
    </a><li><a href="https://class.wildchickenuniversity.com/python/hw1Specification.pdf" /><a href="https://class.wildchickenuniversity.com/python/Lecture2.mp4">Lecture 2 Sept. 23</a></li>
    <ul>
      ...
      <li><a href="https://class.wildchickenuniversity.com/python/hw2.zip">Homework</a> and <a href="https://class.wildchickenuniversity.com/python/hw2Specification.pdf">Specification</a></li><a href="https://class.wildchickenuniversity.com/python/hw2Specification.pdf">
      </a><li><a href="https://class.wildchickenuniversity.com/python/hw2Specification.pdf" /><a href="https://class.wildchickenuniversity.com/python/KeyIdeasOfRecursion.pdf">Key ideas of Recursion</a></li>
    </ul>
    ...
    <ul>
      ...
      <li><a href="https://class.wildchickenuniversity.com/python/hw3.zip">Homework</a> and <a href="https://class.wildchickenuniversity.com/python/hw3Specification.pdf">Specification</a></li><a href="https://class.wildchickenuniversity.com/python/hw3Specification.pdf">
      </a></ul><a href="https://class.wildchickenuniversity.com/python/hw3Specification.pdf">
